...
const About = () => {
  return (
    <>
      <section
        className="about_background py-md-5 overflow-hidden  "
        id="about"
      >
        <Container>
          <Row className="justify-content-between align-items-center">
            <Col md={7}>
              <div
                ...
                data-aos-offset="250"
              >
                <div className="light_shadow p-md-5 p-3  ">
                  ...
                  <p className="common_para mb-0 mt-3">
                    ...
                    user-friendly experience to our clients. We specialize in
                    high-quality cannabis for both recreational and medical
                    purposes, while also making sure that you’re getting the
                    best bud for your buck! Along with all the different strains
                    of cannabis that we stock, you can also get your fill of
                    edibles, vapes, CBD, extracts, and even buy magic mushrooms
