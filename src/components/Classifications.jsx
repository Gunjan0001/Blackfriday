...
const Classifications = () => {
  return (
    <section className="hero_background py-md-5 position-relative">
      <img
        className="position-absolute overlay_position1 w-100"
        src={overlays}
        alt="overlay"
      />
      <img
        ...
        <Row className="my-md-3">
          <Col lg={6}>
            <div className="shadows p-xl-5  p-3">
              ...
              <p className="common_para mb-0">Tried, tested, and affordable.</p>
              <div className="d-flex gap-2 mt-2 mt-md-4">
                <img src={star} alt="star" />
                <img src={star} alt="star" />
                <img src={star} alt="star" />
